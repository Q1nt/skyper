...
public class GraylogMetricsMonitoringService {
    ...
    private void alert(WidgetConfiguration configuration, SearchResultCountWidgetValue countWidgetValue) {
        ...
        skypeService.sendMessage(TEST_CHAT_ID, message);
    }
