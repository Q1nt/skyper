...
import chatops.dto.TextMessage;
import chatops.dto.TokenInfo;
import chatops.dto.TokenResponse;
...
public class SkypeServiceImpl implements SkypeService {
    ...
    private static final Logger LOG = Logger.getLogger(SkypeServiceImpl.class);
    ...
    public SkypeServiceImpl(RestTemplate http) {
        this.http = http;
    ...
    private MultiValueMap<String, String> createTokenRequest() {
        ...
        map.add("scope", Constants.REQUEST_TOKEN_SCOPE);
